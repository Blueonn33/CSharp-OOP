    ...
    public class Spy
    {
        ...
        public string AnalyzeAccessModifiers(string className)
        {
            ...
            foreach (var property in properties)
            {
                ...
                {
                    result.AppendLine($"{getMethod.Name} have to be private!");
                }
            }
        ...
        public string RevealPrivateMethods(string className)
        {
            ...
            var allMethods = type.GetMethods(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static);
        ...
        public string CollectGettersAndSetters(string className)
        {
            ...
            var allMethods = type.GetMethods(BindingFlags.NonPublic | BindingFlags.Static | BindingFlags.Public |
